...
<body>
<header>
        <div class="logo">Food <b style="color: #4e73d1;">Share</b></div>
        <div class="hamburger">
            <div class="line"></div>
            <div class="line"></div>
            <div class="line"></div>
    ...
    <!-- <section class="cover" >
     ...
     -->
        <div class="profilebox" style="">
            ...
            <p class="headingline" style="text-align: left;font-size:30px; text-decoration-color:#4e73d1"> <img src="" alt="" style="width:40px; height:  height: 25px;; padding-right: 10px; position: relative;" >Profile</p>
<!--             
            ...
            <br> -->
              ...
              <a href="logout.php" style="float: left;margin-top: 6px ;border-radius:5px; background-color: #4e73d1; color: white;padding: ;padding-left: 10px;padding-right: 10px; " >Logout</a>
              </div>
              <br>
              <br>
   ...
   <div class="table-container">
        ...
        <thead>
        <tr>
            <th style="background-color:#4e73d1">food</th>
            <th style="background-color:#4e73d1">Type</th>
            <th style="background-color:#4e73d1">Category</th>
            <th style="background-color:#4e73d1">date/time</th>
        </tr>
        </thead>
       <tbody>
